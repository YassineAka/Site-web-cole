...
class Model
{
    ...
    public static function getVersion(){
        ...
        $result3=shell_exec("git log --format=\"H%\" -n 1");
        $result4=shell_exec('git log --format=\"H%\" -n 1');
        $result5=shell_exec('git log --format=\'H%\' -n 1');

        $ret = array($result,$result2,$result3,$result4,$result5);
